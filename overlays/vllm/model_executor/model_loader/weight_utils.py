...
def get_quant_config(
    ...
    if not isinstance(hf_overrides, dict):
        ...
        # quantized online via speculative_config["quantization"]) carry a
        # callable hf_overrides and no dict; fall through to the online-quant /
        # file-based paths instead of failing. (bird/vllm-lil 5b79ea9c)
        hf_overrides = {}

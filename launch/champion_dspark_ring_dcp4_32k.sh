...
ENVV=(
  ...
  -e "VLLM_USE_V2_MODEL_RUNNER=1" -e "VLLM_MTP_INSTRUMENT=1" -e "VLLM_MTP_INSTRUMENT_WINDOW=32" -e "VLLM_USE_FLASHINFER_SAMPLER=1" -e "CUDA_DEVICE_MAX_CONNECTIONS=4"
  -e "KV_FP8_ROPE=1"
...
KMOUNTS=(
  -v "$OVERLAY_DIR/dspark-ring/qwen3_dflash.py:$FM/models/qwen3_dflash.py:ro"
  -v "$OVERLAY_DIR/dspark-ring/kv_cache_manager.py:/usr/local/lib/python3.12/dist-packages/vllm/v1/core/kv_cache_manager.py:ro"
  -v "$OVERLAY_DIR/dspark-ring/cp_utils.py:/usr/local/lib/python3.12/dist-packages/vllm/v1/worker/cp_utils.py:ro"
  -v "$OVERLAY_DIR/dspark-ring/speculators_algos.py:/usr/local/lib/python3.12/dist-packages/vllm/transformers_utils/configs/speculators/algos.py:ro"
  -v "$OVERLAY_DIR/registry.py:$BACKENDS/registry.py:ro"
  -v "$OVERLAY_DIR/weight_utils.py:/usr/local/lib/python3.12/dist-packages/vllm/model_executor/model_loader/weight_utils.py:ro"
  -v "$OVERLAY_DIR/parallel_state.py:/usr/local/lib/python3.12/dist-packages/vllm/distributed/parallel_state.py:ro"
  -v "$OVERLAY_DIR/adaptive/scheduler.py:/usr/local/lib/python3.12/dist-packages/vllm/v1/core/sched/scheduler.py:ro"
  -v "$OVERLAY_DIR/adaptive/cudagraph_utils.py:/usr/local/lib/python3.12/dist-packages/vllm/v1/worker/gpu/cudagraph_utils.py:ro"
  -v "$OVERLAY_DIR/adaptive/config_scheduler.py:/usr/local/lib/python3.12/dist-packages/vllm/config/scheduler.py:ro"
  -v "$OVERLAY_DIR/adaptive/config_speculative.py:/usr/local/lib/python3.12/dist-packages/vllm/config/speculative.py:ro"
  -v "$OVERLAY_DIR/adaptive/config_vllm.py:/usr/local/lib/python3.12/dist-packages/vllm/config/vllm.py:ro"
  -v "$OVERLAY_DIR/adaptive/arg_utils.py:/usr/local/lib/python3.12/dist-packages/vllm/engine/arg_utils.py:ro"
  -v "$OVERLAY_DIR/adaptive/deepseek_mtp.py:/usr/local/lib/python3.12/dist-packages/vllm/model_executor/models/deepseek_mtp.py:ro"
  -v "$OVERLAY_DIR/adaptive/dynamic/acceptance_length.py:/usr/local/lib/python3.12/dist-packages/vllm/v1/spec_decode/dynamic/acceptance_length.py:ro"
  -v "$OVERLAY_DIR/adaptive/dynamic/depth_ladder.py:/usr/local/lib/python3.12/dist-packages/vllm/v1/spec_decode/dynamic/depth_ladder.py:ro"
  -v "$OVERLAY_DIR/mrv2/model_runner.py:/usr/local/lib/python3.12/dist-packages/vllm/v1/worker/gpu/model_runner.py:ro"
  -v "$OVERLAY_DIR/mrv2/warmup.py:/usr/local/lib/python3.12/dist-packages/vllm/v1/worker/gpu/warmup.py:ro"
  -v "$OVERLAY_DIR/mrv2/spec_decode/utils.py:/usr/local/lib/python3.12/dist-packages/vllm/v1/worker/gpu/spec_decode/utils.py:ro"
  -v "$OVERLAY_DIR/mrv2/spec_decode/autoregressive/speculator.py:/usr/local/lib/python3.12/dist-packages/vllm/v1/worker/gpu/spec_decode/autoregressive/speculator.py:ro"
  -v "$OVERLAY_DIR/dspark-ring/dflash_speculator.py:/usr/local/lib/python3.12/dist-packages/vllm/v1/worker/gpu/spec_decode/dflash/speculator.py:ro"
  ...
  -v "$OVERLAY_DIR/mrv2/spec_decode/speculator.py:/usr/local/lib/python3.12/dist-packages/vllm/v1/worker/gpu/spec_decode/speculator.py:ro"
...
SERVE=(
  ...
  --attention-backend B12X_MLA_SPARSE --disable-custom-all-reduce --hf-overrides '{}'
  --tensor-parallel-size 4 --pipeline-parallel-size 1
  --decode-context-parallel-size 4
  --dcp-comm-backend a2a
  
  --speculative-config '{"method":"dspark","model":"/cache/huggingface/hub/dspark-quanttrio-ft","num_speculative_tokens":3,"attention_backend":"TRITON_ATTN","quantization":"compressed-tensors","kv_cache_dtype":"auto"}'
  --async-scheduling --enable-decode-aware-prefill --long-prefill-token-threshold 2048 --decode-prefill-token-budget 256 --idle-prefill-token-budget 2048 --max-long-prefills-per-step 1
  ...
  --watermark 0.02
  --compilation-config '{"cudagraph_mode":"FULL","cudagraph_capture_sizes":[4,8,12,16]}'
)

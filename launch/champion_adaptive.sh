...
SERVE=(
  ...
  --speculative-config '{"method":"mtp","num_speculative_tokens":5,"adaptive_speculative_tokens_window":32,"draft_tensor_parallel_size":1,"attention_backend":"B12X_MLA_SPARSE","quantization":"compressed-tensors","draft_sample_method":"probabilistic"}'
  ...
  --watermark 0.02
  --compilation-config '{"cudagraph_mode":"FULL","cudagraph_capture_sizes":[6,12,18,24,30,36,42,48]}'
)
